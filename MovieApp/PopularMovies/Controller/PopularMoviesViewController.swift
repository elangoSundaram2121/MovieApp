...
final class PopularMoviesViewController: UIViewController {
    ...
    private func configureCollectionView() {
        ...
        collectionView.register(
            ...
            withReuseIdentifier: "popularMoviesCollectionFooterIdentifier"
        )
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionView.elementKindSectionFooter:
            let footer = collectionView.dequeueReusableSupplementaryView(
                ...
                withReuseIdentifier: String(describing: "popularMoviesCollectionFooterIdentifier"),
                for: indexPath
            )
...
// MARK: PopularMoviesViewModelDelegate Methods

extension PopularMoviesViewController: PopularMoviesViewModelDelegate, Loadable, Alertable {
    func showLoading() {
